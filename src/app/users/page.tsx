  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 2, sm: 4 }, px: { xs: 1, sm: 2 } }}>
      ...
      >
        ...
        <Box display="flex" gap={2} flexWrap="wrap" mb={3} alignItems="center" flexDirection={{ xs: 'column', sm: 'row' }}>
          <TextField
        ...
        >
          {loading && users.length > 0 && (
            ...
            >
              <CircularProgress size={40} sx={{ color: 'var(--app-text)' }} />
            </Box>
          )}
                          ...
                          <TableCell>
                            {user.role !== 'companyOwner' && (
                              <Button
                                ...
                                disabled={user.whopUserId === currentUserId}
                                sx={{
