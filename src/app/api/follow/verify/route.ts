...
export async function GET(request: NextRequest) {
  try {
    ...
    // companyId is optional for cross-company follows, but we still need it to find the user record
    // If companyId is not provided, we'll try to find user by whopUserId only
